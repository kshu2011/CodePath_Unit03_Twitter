...
class TwitterAPICaller: BDBOAuth1SessionManager {
   ...
   // static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "fSFOi1HyBuV5Kp0K5fKDV1o2n", consumerSecret: "jEyOGoMWbF7jSP373bBed7ZltHrQF8pCA6uOwYwelBa90LQ4vq")
